...
namespace VidyoClient
{
	public class Endpoint{
		...
		public Boolean SelectVirtualWindowShare(VirtualVideoSource virtualWindowShare){
		...
		public void VirtualWindowShareSelectAdvanced(VirtualVideoSource virtualWindowShare){
